...
import eth.bruises.basic.dto.Point;
...
public class DistanceUtil {
    ...
    public static Point getPoint(String address) {
        //配置上自己的百度地图应用的AK
        String Application_ID = "pEHwPrt2ZHpdERqmS97emCLFvxp6BngS";
        try {
            String sCurrentLine = "";
            String sTotalString = "";
     ...
     * 根据两点间经纬度坐标（double值），计算两点间距离，单位为米
     *
     * @param searchMasterMsgAddres 用户指定的地址
     * @param shops                 商店
     * @return
     */
    public static Shop getNearestShop(String searchMasterMsgAddres, List<Shop> shops) {

        try {
            Point point = getPoint(searchMasterMsgAddres);
